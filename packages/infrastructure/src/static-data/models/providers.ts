...
}[] = Object.entries(ModelProviderMap).map(([key, value]) => ({
  provider: key,
  value,
}));
...
export const aiproxyChannels: AIProxyChannelsType = [
  ...
  {
    channelId: 45,
    name: { en: "Grok", "zh-CN": "Grok", "zh-Hant": "Grok" },
    avatar: "grok",
    website: "https://x.ai",
  },
  ...
  {
    channelId: 33,
    name: { en: "AWS", "zh-CN": "AWS", "zh-Hant": "AWS" },
    avatar: "aws",
  ...
  {
    channelId: 29,
    name: { en: "Groq", "zh-CN": "Groq", "zh-Hant": "Groq" },
    avatar: "groq",
    website: "https://groq.com",
  },
  {
    channelId: 47,
    name: { en: "JinaAI", "zh-CN": "JinaAI", "zh-Hant": "JinaAI" },
    avatar: "jina",
  ...
  {
    channelId: 19,
    name: { en: "ai360", "zh-CN": "ai360", "zh-Hant": "ai360" },
    avatar: "ai360",
    website: "https://ai360.com",
  },
  {
    channelId: 26,
  ...
  {
    channelId: 46,
    name: { en: "Doc2X", "zh-CN": "Doc2X", "zh-Hant": "Doc2X" },
    avatar: "doc2x",

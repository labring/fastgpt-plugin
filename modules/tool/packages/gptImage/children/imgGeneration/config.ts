  ...
  versionList: [
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          toolDescription: 'The size of the image to be generated',
          valueType: WorkflowIOValueTypeEnum.string,
          required: false,
        ...
        },
        {
          ...
          label: '图片质量',
          renderTypeList: [FlowNodeInputTypeEnum.select, FlowNodeInputTypeEnum.reference],
          toolDescription: 'The quality of the image to be generated',
          valueType: WorkflowIOValueTypeEnum.string,
          required: false,
          defaultValue: 'medium',
          list: [
        ...
        },
        {
          ...
          label: '背景透明度',
          renderTypeList: [FlowNodeInputTypeEnum.select, FlowNodeInputTypeEnum.reference],
          toolDescription: 'The background transparency of the image to be generated',
          valueType: WorkflowIOValueTypeEnum.string,
          required: false,
          defaultValue: 'auto',
          list: [
        ...
        },
        {
          ...
          label: '图片审查级别',
          renderTypeList: [FlowNodeInputTypeEnum.select, FlowNodeInputTypeEnum.reference],
          toolDescription: 'The moderation level of the image to be generated',
          valueType: WorkflowIOValueTypeEnum.string,
          required: false,
          defaultValue: 'auto',
          list: [
